...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		...
		// 4. Otherwise say "wrong"
			...
			speak("wrong, learn to spell");
		}

		// 5. repeat the process for other words
		speak("spell supercalifragilisticexpialidocious");
		String hi = JOptionPane.showInputDialog("What is your answer?");
		if(hi.equalsIgnoreCase("supercalifragilisticexpialidocious")){
		speak("Correct");
		}
		else{
			speak("wrong, go back to first grade");
		}
